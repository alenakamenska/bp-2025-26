    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpeningHours", x => new { x.Day, x.BusinessId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessUser_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "11111111-1111-1111-1111-111111111111", "d7c1fba5-0870-4d69-9d74-eb718742b00e", "Admin", "ADMIN" },
                    { "22222222-2222-2222-2222-222222222222", "0656fd2b-5a45-43d4-a544-4c7364a3a822", "Business", "BUSINESS" },
                    { "33333333-3333-3333-3333-333333333333", "132225b5-f808-4d83-b832-d82f9d35def7", "User", "USER" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa", 0, "9b7962a4-6800-4c6c-a436-9d2d9f00cf4e", "admin@localhost", true, false, null, "ADMIN@LOCALHOST", "ADMIN@LOCALHOST", "AQAAAAIAAYagAAAAEItGDJJ3JLd4VYEr0ESHyA2lbwRJ+P6zdC2IOZjeXN5aUi7N1cvaKOY7Gr4mgTtk1w==", null, false, null, "00896de5-1558-4fe3-b2ec-1179290fc94b", false, "admin@localhost" });
